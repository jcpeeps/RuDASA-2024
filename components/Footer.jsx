			...
			<div className="container mt-5 mb-3 d-flex flex-column align-items-center">
				<div className="row w-100 d-flex flex-column flex-md-row justify-content-center align-items-start">
					...
					<div className="col d-flex flex-column">
						...
						<div className="bg-white rounded p-2 p my-1 w-100"><a href="https://payf.st/4c8zd" className="text-white text-decoration-none"><FontAwesomeIcon icon={faHandHoldingHeart} className="pe-2"/>Lend a hand</a></div>
					</div
</div>
					</div>
				</div>
