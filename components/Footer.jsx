			...
			<div className="container mt-5 mb-3 d-flex flex-column align-items-center">
				<div className="row w-100 d-flex flex-column flex-md-row justify-content-center align-items-start">
					...
					<div className="col d-flex flex-column">
						...
						<div form name="PayFastPayNowForm" action="https://payment.payfast.io/eng/process" method="post">
...
<td><input required id="PayFastAmount" type="number" step=".01" name="amount" min="5.00" placeholder="5.00" value="100"></td>
</tr>
</table>

<input required type="hidden" name="item_name" maxlength="255" value="Donate to RuDASA">
<input type="hidden" name="item_description" maxlength="255" value="People can donate any amount">
<table>
<tr>
