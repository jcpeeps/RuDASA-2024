                    ...
                    <div className="advocacy-examples">
                        <div className="bg-white rounded shadow p-4 m-3 p-md-5">
                            ...
                            <ul className="styled-bullets">
                                ...
                                <li>Magni possimus non voluptatibus rem deserunt blanditiis ratione eos, reiciendis labore dolores.</li>
                                <li>Asperiores deserunt ratione corporis commodi cupiditate dignissimos, nihil modi reprehenderit beatae veniam.</li>
                                <li>Illo optio obcaecati ea velit necessitatibus eius consequatur iure quia dolore inventore.</li>
                                <li>Natus sit aperiam nobis delectus blanditiis placeat error, iure amet eaque temporibus!</li>
                                <li>Iste deserunt molestiae ullam reprehenderit at minima hic cupiditate quo quos error?</li>
                                <li>Esse explicabo quisquam quam ex laudantium similique at mollitia quaerat illum nostrum.</li>
                            </ul>
                        </div>
