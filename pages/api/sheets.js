...
As a member of our organization, you will have access to a wealth of resources and information designed to aid you in all your rural health endeavours:
    ∙ Access to the Google Group Forum which receives daily updates. This is our primary form of communication with members.
      ...
      To access details on a topic, or get attachments, just click on the blue header to go to the Google Group webpage. You have to use your email and create a password to enter if you do not have a Google account.
    ...
    Join your Provincial Buddies WhatsApp Group here - only join 1 Province as this is how you share information about what is available in your province. 
    If you are an international member choose any province. If items are of interest to all Buddies the RuDASA Office will forward to all Buddies.
    ...
    Once you use the link we get a message to approve you joining the group. Please introduce yourself and say where you are working so that you can immediately link to others in the area. 
